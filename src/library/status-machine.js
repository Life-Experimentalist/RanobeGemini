 ...
 *   builtIn     : boolean      - true \u{2192} can be disabled but not deleted
 ...
 * Built-in rules are merged at runtime \u{2014} only the mutable fields
 ...
 * placeholder (0) \u{2014} callers replace it with `settings.autoHoldDays`.
 *
 * @returns {Array<Object>}
 */
export function getBuiltInRules() {
	return [
		// \u{2500}\u{2500} Inactivity rules \u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}
		{
		...
		// \u{2500}\u{2500} Chapter-read rules \u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}
		{
		...
		// \u{2500}\u{2500} Resume / start rules \u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}\u{2500}
		{
...
/**
 * Import lazily to avoid circular deps \u{2014} call this where READING_STATUS_INFO is available.
 ...
 *
 * @param {Object} novel   - novel record (readingStatus, rereadingStatus, \u{2026})
 ...
 *
 * @param {Object} novel   - novel record (readingStatus, lastAccessedAt, \u{2026})
 * @param {Array<Object>} rules - merged rules (from mergeRules())
 * @returns {string|null} target status key, or null if no rule matched
 */
