...
2. I want modularity in the following:
...
3. Enhance the library to be better done with more comprehensive settings

4. Make the extension more accessible by adding keyboard shortcuts for more actions and better screen reader support (future)

5. Make the popup better designed and more user friendly

6. Make the notification system better by adding a notification center page in the library and popup with better notification grouping and handling

7. Make the AI model settings better by adding presets for different use cases like creative writing, technical writing, etc. (future)

8. Make the theme system better by adding more themes and allowing users to create their own themes (future)

9.  Improve the performance of the extension by optimizing the code and reducing the memory usage (ongoing)

10. Add more websites to the supported list by creating new handlers (ongoing)

11. Improve the testing coverage of the extension by adding more unit and integration tests (ongoing)

12. Improve the documentation of the extension by adding more examples and tutorials (ongoing)

13. Gather user feedback and suggestions to improve the extension (ongoing)
