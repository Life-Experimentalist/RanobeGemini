...
- [Mobile Testing Guide for Ranobe Gemini](#mobile-testing-guide-for-ranobe-gemini)
	- [Table of Contents](#table-of-contents)
	- [Firefox Mobile (Android)](#firefox-mobile-android)
		- [Prerequisites](#prerequisites)
		- [Installation Steps](#installation-steps)
			- [Method 1: Firefox Nightly (Recommended for Development)](#method-1-firefox-nightly-recommended-for-development)
			- [Method 2: Firefox for Android (Stable) - Custom Collection](#method-2-firefox-for-android-stable---custom-collection)
		- [Testing Features on Firefox Mobile](#testing-features-on-firefox-mobile)
	- [Edge Mobile (Android)](#edge-mobile-android)
		- [Current Status](#current-status)
		- [Workaround Options](#workaround-options)
			- [Option 1: Wait for Official Edge Mobile Extension Support](#option-1-wait-for-official-edge-mobile-extension-support)
			- [Option 2: Test on Edge Desktop (Windows/Mac/Linux)](#option-2-test-on-edge-desktop-windowsmaclinux)
			- [Option 3: Kiwi Browser (Chromium-based Alternative)](#option-3-kiwi-browser-chromium-based-alternative)
	- [iOS Limitations](#ios-limitations)
		- [Safari iOS](#safari-ios)
		- [Current Status](#current-status-1)
		- [Potential Future Solution](#potential-future-solution)
	- [Testing Checklist](#testing-checklist)
		- [Basic Functionality](#basic-functionality)
		- [UI/UX Mobile-Specific](#uiux-mobile-specific)
	...
	- [Known Mobile Issues](#known-mobile-issues)
		...
		- [Google Drive OAuth on Mobile](#google-drive-oauth-on-mobile)
		- [Popup Width on Small Screens](#popup-width-on-small-screens)
	- [Debugging on Mobile](#debugging-on-mobile)
		- [Firefox Mobile Debugging](#firefox-mobile-debugging)
		- [Edge Mobile Debugging (via Kiwi Browser)](#edge-mobile-debugging-via-kiwi-browser)
	- [Performance Testing](#performance-testing)
		- [Memory Profiling](#memory-profiling)
		- [Network Profiling](#network-profiling)
	- [Reporting Mobile-Specific Issues](#reporting-mobile-specific-issues)
	- [Additional Resources](#additional-resources)
	- [Contributing Mobile Fixes](#contributing-mobile-fixes)
...
- Extension built for Firefox (see [Build System](../build/BUILD_SYSTEM.md))
