...
- [Build Architecture](#build-architecture)
	...
	- [Build Process](#build-process)
		...
		- [Step 2: Load Platform Manifest](#step-2-load-platform-manifest)
		- [Step 3: Update Version](#step-3-update-version)
		- [Step 4: Copy Assets](#step-4-copy-assets)
		- [Step 5: Package](#step-5-package)
	- [Platform-Specific Features](#platform-specific-features)
		- [Firefox Manifest (`manifest-firefox.json`)](#firefox-manifest-manifest-firefoxjson)
		- [Chromium Manifest (`manifest-chromium.json`)](#chromium-manifest-manifest-chromiumjson)
	- [Common Features](#common-features)
	- [Commands](#commands)
	- [File Changes Flow](#file-changes-flow)
