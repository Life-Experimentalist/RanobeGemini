...
- [📝 Detailed Code Changes Summary](#-detailed-code-changes-summary)
	- [Table of Contents](#table-of-contents)
	- [File: `src/utils/constants.js`](#file-srcutilsconstantsjs)
		- [Changes Made](#changes-made)
		- [Why](#why)
	- [File: `src/utils/drive.js`](#file-srcutilsdrivejs)
		- [Changes Made](#changes-made-1)
			- [New Functions](#new-functions)
		- [How They Work](#how-they-work)
		- [Lines of Code](#lines-of-code)
	- [File: `src/background/background.js`](#file-srcbackgroundbackgroundjs)
		- [Changes Made](#changes-made-2)
			- [1. Updated Imports](#1-updated-imports)
			- [2. Updated uploadLibraryBackupToDrive Function](#2-updated-uploadlibrarybackuptodrive-function)
			- [3. Added Message Handlers](#3-added-message-handlers)
		- [Why](#why-1)
	- [File: `src/popup/popup.html`](#file-srcpopuppopuphtml)
		- [Changes Made](#changes-made-3)
		- [Why](#why-2)
	- [File: `src/popup/popup.js`](#file-srcpopuppopupjs)
		- [Changes Made](#changes-made-4)
			- [1. Added Element Selections](#1-added-element-selections)
			- [2. Added Functions](#2-added-functions)
			- [3. Added Event Listeners](#3-added-event-listeners)
			- [4. Initialize Drive UI on Popup Load](#4-initialize-drive-ui-on-popup-load)
		- [Why](#why-3)
	- [File: `landing/oauth-redirect.html`](#file-landingoauth-redirecthtml)
		- [No Changes Needed ✅](#no-changes-needed-)
	- [File: `src/manifest.json`](#file-srcmanifestjson)
		- [No Changes Needed ✅](#no-changes-needed--1)
	- [Documentation Files Created](#documentation-files-created)
		- [New Documentation Files](#new-documentation-files)
		- [Lines of Documentation](#lines-of-documentation)
