...
- [Complete Google Drive Backup Implementation Guide](#complete-google-drive-backup-implementation-guide)
	- [Table of Contents](#table-of-contents)
	- [What Was Implemented](#what-was-implemented)
		- [User Features](#user-features)
		- [Technical Features](#technical-features)
	- [OAuth Scopes \& Configuration](#oauth-scopes--configuration)
		- [Scope Used](#scope-used)
		- [Why Not Other Scopes?](#why-not-other-scopes)
		- [Configuration Constants](#configuration-constants)
	- [Google Cloud Setup (Step-by-Step)](#google-cloud-setup-step-by-step)
		- [Prerequisites](#prerequisites)
		- [Finding Extension IDs](#finding-extension-ids)
		...
		- [Step 5: Copy Your Client ID](#step-5-copy-your-client-id)
		- [Step 6: Update Extension (Optional)](#step-6-update-extension-optional)
	...
	- [Files Modified \& Created](#files-modified--created)
		- [Modified Files](#modified-files)
			...
			- [`src/utils/constants.js`](#srcutilsconstantsjs)
			- [`src/utils/drive.js`](#srcutilsdrivejs)
			- [`src/background/background.js`](#srcbackgroundbackgroundjs)
			- [`src/popup/popup.html`](#srcpopuppopuphtml)
			- [`src/popup/popup.js`](#srcpopuppopupjs)
		- [Created Files](#created-files)
			- [`docs/guides/GOOGLE_DRIVE_BACKUP_SETUP.md`](#docsguidesgoogle_drive_backup_setupmd)
			- [`docs/guides/OAUTH_SETUP_DETAILED.md`](#docsguidesoauth_setup_detailedmd)
			- [`docs/guides/COMPLETE_GOOGLE_DRIVE_IMPLEMENTATION.md` (this file)](#docsguidescomplete_google_drive_implementationmd-this-file)
	...
	- [Testing Guide](#testing-guide)
		- [Before Public Release](#before-public-release)
			- [Test 1: Initial Setup](#test-1-initial-setup)
			- [Test 2: Manual Backup](#test-2-manual-backup)
			- [Test 3: View Backups](#test-3-view-backups)
			- [Test 4: Scheduled Backups](#test-4-scheduled-backups)
			- [Test 5: Continuous Backups](#test-5-continuous-backups)
			- [Test 6: Restore from Backup](#test-6-restore-from-backup)
			- [Test 7: Token Refresh](#test-7-token-refresh)
			- [Test 8: Disconnect](#test-8-disconnect)
			- [Test 9: Browser Compatibility](#test-9-browser-compatibility)
			- [Test 10: Error Handling](#test-10-error-handling)
	- [Troubleshooting](#troubleshooting)
		...
		- [Can't restore backup](#cant-restore-backup)
