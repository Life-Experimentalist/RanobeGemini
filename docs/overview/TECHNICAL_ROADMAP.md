...
| 1-U3 DOM integration boundary extraction (L0)                  | 2-3              | 1              | -1.0 vs midpoint | Shared master-banner insertion path extracted before wider boundary split | valid        | Continue migrating insertion contracts into dom-integration helpers     | 2026-04-16   |
