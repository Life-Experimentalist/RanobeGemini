...
- [Firefox Drive Sync Fix \& Backup v2.0 Features](#firefox-drive-sync-fix--backup-v20-features)
	- [Table of Contents](#table-of-contents)
	- [Issue Fixed: Firefox Not Auto-Syncing After OAuth ✅](#issue-fixed-firefox-not-auto-syncing-after-oauth-)
		- [Problem](#problem)
		- [Root Cause](#root-cause)
		- [Solution Implemented](#solution-implemented)
		- [Expected Behavior Now](#expected-behavior-now)
	- [Backup v2.0 Features (Already Implemented) 🎉](#backup-v20-features-already-implemented-)
		- [What Gets Backed Up](#what-gets-backed-up)
			- [📚 Library Data](#-library-data)
			- [🔑 API Keys \& Credentials](#-api-keys--credentials)
			- [⚙️ Model Settings](#️-model-settings)
			- [🎨 Theme \& Appearance](#-theme--appearance)
			- [🌐 Site Settings](#-site-settings)
			- [💾 Backup Preferences](#-backup-preferences)
		- [How to Use Complete Backup/Restore](#how-to-use-complete-backuprestore)
			- [Option 1: Same Device (Settings Preserved)](#option-1-same-device-settings-preserved)
			- [Option 2: New Device or Browser (Complete Fresh Start)](#option-2-new-device-or-browser-complete-fresh-start)
		- [Backup Version History](#backup-version-history)
	- [Auto-Restore Feature 🔄](#auto-restore-feature-)
		- [What It Does](#what-it-does)
		- [How to Control It](#how-to-control-it)
		- [Manual Sync Button](#manual-sync-button)
	- [Testing Checklist for Firefox Drive Sync](#testing-checklist-for-firefox-drive-sync)
		- [Edge Desktop (Already Working)](#edge-desktop-already-working)
		- [Firefox Desktop (Now Fixed)](#firefox-desktop-now-fixed)
		- [Chrome Desktop](#chrome-desktop)
		- [Mobile (Edge/Chrome)](#mobile-edgechrome)
	- [Troubleshooting](#troubleshooting)
		- ["Drive is connected but not syncing"](#drive-is-connected-but-not-syncing)
		- ["Settings not restored after import"](#settings-not-restored-after-import)
		- ["OAuth credentials not importing"](#oauth-credentials-not-importing)
