...
- [ZIP Packaging Fix - December 23, 2025](#zip-packaging-fix---december-23-2025)
	- [Table of Contents](#table-of-contents)
	- [Problem](#problem)
	- [Root Cause](#root-cause)
	- [Solution](#solution)
		- [Updated Error Handling](#updated-error-handling)
		- [Files Modified](#files-modified)
		- [Key Changes](#key-changes)
	- [Build Process](#build-process)
		- [Rebuild \& Repackage](#rebuild--repackage)
		- [Full Publish Workflow](#full-publish-workflow)
	- [Validation Results](#validation-results)
		- [Firefox ZIP](#firefox-zip)
		- [Chromium ZIP](#chromium-zip)
