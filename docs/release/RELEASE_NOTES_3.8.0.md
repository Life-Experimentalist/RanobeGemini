...
- [Ranobe Gemini v3.8.0 Release Notes](#ranobe-gemini-v380-release-notes)
	- [Table of Contents](#table-of-contents)
	- [🎯 What's New](#-whats-new)
		- [OAuth Setup \& Google Drive Improvements](#oauth-setup--google-drive-improvements)
			- [**Redesigned OAuth Setup Flow**](#redesigned-oauth-setup-flow)
			- [**Google Drive Backup Workflow**](#google-drive-backup-workflow)
		- [Backup System Enhancements](#backup-system-enhancements)
			- [**Persistent Backup Options**](#persistent-backup-options)
			- [**Comprehensive Version Handling**](#comprehensive-version-handling)
			- [**OAuth Credentials in Backups**](#oauth-credentials-in-backups)
		- [UI/UX Improvements](#uiux-improvements)
			- [**Theme Integration**](#theme-integration)
			- [**Better Visual Feedback**](#better-visual-feedback)
	...
	- [🚀 Getting Started](#-getting-started)
		- [First-Time OAuth Setup](#first-time-oauth-setup)
	...
	- [📅 Upgrade Path](#-upgrade-path)
		- [From v3.7.x](#from-v37x)
		- [From v3.6.x or older](#from-v36x-or-older)
	- [🎉 Thank You](#-thank-you)
